...
const COLORS = {
    ...
    string: 'var(--Fresnica-code-string)',
    keyword: 'var(--Fresnica-code-keyword)',
    react: 'var(--Fresnica-code-react)',
    component: 'var(--Fresnica-code-component)',
    func: 'var(--Fresnica-code-function)',
    prop: 'var(--Fresnica-code-property)',
    jsx: 'var(--Fresnica-code-jsx)',
    operator: 'var(--Fresnica-code-operator)',
    number: 'var(--Fresnica-code-number)',
    default: 'var(--Fresnica-code-text)',
};
