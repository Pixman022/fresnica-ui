...
describe('CodeBlock', () => {
    ...
    it('默认可复制代码并显示成功反馈', async () => {
        ...
        const onCopy = vi.fn();
        render(<CodeBlock code="const Fresnica = true;" onCopy={onCopy} />);

        await user.click(screen.getByRole('button', { name: '复制代码' }));
        expect(writeText).toHaveBeenCalledWith('const Fresnica = true;');
        expect(onCopy).toHaveBeenCalledWith('const Fresnica = true;');
