...
describe('Tag', () => {
    ...
    describe('color', () => {
        ...
        it('color=app-red + solid 应用 color-app-red-solid 类', () => {
            const { container } = render(
                <Tag color="app-red" variant="solid">
                    x
                </Tag>
            );
            expect(container.firstChild).toHaveClass(styles['color-app-red-solid']);
        });
        ...
        it('color=app-red + soft 应用 color-app-red-soft 类', () => {
            const { container } = render(
                <Tag color="app-red" variant="soft">
                    x
                </Tag>
            );
            expect(container.firstChild).toHaveClass(styles['color-app-red-soft']);
        });

        it('color=app-teal + soft 应用 color-app-teal-soft 类', () => {
            const { container } = render(
                <Tag color="app-teal" variant="soft">
                    x
                </Tag>
            );
            expect(container.firstChild).toHaveClass(styles['color-app-teal-soft']);
        });
    });
