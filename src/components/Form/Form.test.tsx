...
describe('Form', () => {
    ...
    describe('布局', () => {
        it('layout=vertical 时 FormItem 渲染为 block', () => {
            ...
            expect(container.querySelector(`.${styles['Fresnica-form-vertical']}`)).toBeInTheDocument();
        });
        ...
        it('layout=horizontal 时使用 grid 布局', () => {
            ...
            expect(container.querySelector(`.${styles['Fresnica-form-horizontal']}`)).toBeInTheDocument();
        });
        ...
        it('layout=inline 时 Form 渲染为 flex', () => {
            ...
            expect(container.querySelector(`.${styles['Fresnica-form-inline']}`)).toBeInTheDocument();
        });

        it('size=small 应用 Fresnica-form-small 类', () => {
            const { container } = render(
                <Form size="small">
                    <Form.Item name="s">
                        <Input />
            ...
            expect(container.querySelector(`.${styles['Fresnica-form-small']}`)).toBeInTheDocument();
        });
    });
    ...
    describe('Form.useForm + 表单实例', () => {
        ...
        it('回归: setFieldsValue 数组值当 state，不递归', () => {
            let formRef: FormInstance | null = null;
            function Bind() {
                const [form] = Form.useForm();
                formRef = form;
    ...
    describe('校验', () => {
        ...
        it('type=integer 规则：字符串数字按整数校验', async () => {
            ...
            expect(onFinish).not.toHaveBeenCalled();
            expect(container.querySelector('.' + styles['Fresnica-form-item-explain-error'])).toBeTruthy();
    ...
    describe('提交', () => {
        ...
        it('required + whitespace: 纯空格也算空', async () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-explain-error'])).toBeNull();
        });
    ...
    describe('label / colon / requiredMark', () => {
        ...
        it('colon=false 时不显示冒号', () => {
            ...
            // Fresnica-form-item-label-colon 类不存在
            expect(container.querySelector('.' + styles['Fresnica-form-item-label-colon'])).toBeNull();
        });
        ...
        it('colon=true (默认) 时显示冒号', () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-label-colon'])).toBeInTheDocument();
        });
        ...
        it('requiredMark=false 时不显示星号', () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-label-required'])).toBeNull();
        });
        ...
        it('requiredMark=true (显式开启) 时显示星号', () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-label-required'])).toBeInTheDocument();
        });
    ...
    describe('高级功能', () => {
        it('noStyle 时不渲染外层 label/wrapper 容器', () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-label'])).toBeNull();
            expect(container.querySelector('.' + styles['Fresnica-form-item-control'])).toBeNull();
            // input 还在
            expect(screen.getByRole('textbox')).toBeInTheDocument();
        });

        it('hasFeedback 时错误状态下显示 Lucide 错误图标', async () => {
            const { container } = render(
                <Form>
            ...
            const feedback = container.querySelector('.' + styles['Fresnica-form-item-feedback-icon']);
        ...
        it('validateStatus=success 手动指定覆盖自动推断', () => {
            ...
            expect(container.querySelector('.' + styles['Fresnica-form-item-has-success'])).toBeInTheDocument();
        });
