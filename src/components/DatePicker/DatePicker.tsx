...
export const DatePicker: React.FC<DatePickerProps> = ({
    ...
    const idPrefix = `Fresnica-date-picker-${useId().replace(/:/g, '')}`;
                            ...
                            <div className={styles.header}>
                                <div className={styles.headerGroup}>
                                    <button
                                        ...
                                        onMouseDown={(e) => e.preventDefault()}
                                    >
                                        <ChevronLeft className={styles.navIcon} size={14} aria-hidden="true" />
                                    </button>
                                    {mode === 'date' && (
                                        <button
                                            type="button"
                                ...
                                <div className={styles.headerGroup}>
                                    ...
                                    <button
                                        ...
                                        onMouseDown={(e) => e.preventDefault()}
                                    >
                                        <ChevronRight className={styles.navIcon} size={14} aria-hidden="true" />
                                    </button>
                                </div>
                            </div>
