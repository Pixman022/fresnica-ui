# One-click prompt — generate an fresnica-ui page with any AI tool
...
visual style of the "fresnica-ui" component library, for a non-technical user who
...
- Generation contract (output requirements, CDN setup, component hand-rolling rules):
  https://raw.githubusercontent.com/Pixman022/fresnica-ui/main/skills/fresnica-ui-style/references/standalone-html.md
- Complete `:root` design-token template (exact values):
  https://raw.githubusercontent.com/Pixman022/fresnica-ui/main/docs/design-system/css-variables.md
- Design rules (hard visual contracts and anti-patterns):
  https://raw.githubusercontent.com/Pixman022/fresnica-ui/main/docs/design-system/design-rules.md
