...
individual component props live in `skills/fresnica-ui-style/references/components/*.md`, and individual component
...
| Change                                | Must sync                                                                                          |
| ------------------------------------- | -------------------------------------------------------------------------------------------------- |
| Component API added or changed        | `skills/fresnica-ui-style/references/components/<category>.md` — props copied verbatim from source |
