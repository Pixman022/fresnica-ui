            ...
            <div style={demoBodyStyle}>
                <div>
                    ...
                    <div style={{ ...demoDashedBoxStyle, marginBottom: 20 }}>
                        <Typewriter trigger={replayKey}>欢迎使用 Fresnica，开始管理你的 Stellar 资产。</Typewriter>
                    </div>
                </div>
                ...
                <div>
                    ...
                    >
                        <Typewriter speed={40} trigger={replayKey}>
                            <div>第一行：交易已提交</div>
                            <div>第二行：等待 Stellar 网络确认...</div>
                            <div style={{ color: 'var(--Fresnica-success-color)', fontWeight: 700 }}>
                                第三行：区块已确认
                            </div>
                        </Typewriter>
                    </div>
...
import { Typewriter } from 'fresnica-ui';
