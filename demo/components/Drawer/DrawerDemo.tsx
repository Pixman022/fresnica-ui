...
const DRAWER_API: ApiRow[] = [
    ...
    { prop: 'variant', desc: '抽屉呈现变体', type: "'drawer' | 'sheet'", defaultVal: "'drawer'" },
    { prop: 'showHandle', desc: '底部 sheet 是否显示拖动指示条', type: 'boolean', defaultVal: 'false' },
    { prop: 'safeArea', desc: '是否适配设备安全区', type: 'boolean', defaultVal: 'true' },
    {
        prop: 'footer',
...
const DrawerDemo: React.FC = () => {
    ...
    return (
        <div style={sectionStyle}>
            ...
            <Drawer open={rightOpen} title="钱包设置" onClose={() => setRightOpen(false)}>
    ...
    return (
        <>
            ...
            <Drawer open={open} title="钱包设置" onClose={() => setOpen(false)}>
                <p>背景会下沉，突出抽屉主体。</p>
            </Drawer>
        </>
    );
