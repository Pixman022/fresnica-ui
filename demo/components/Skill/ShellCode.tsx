...
const COLORS = {
    ...
    file: 'var(--Fresnica-code-component)',
    command: 'var(--Fresnica-code-function)',
    option: 'var(--Fresnica-code-property)',
    network: 'var(--Fresnica-code-operator)',
};
