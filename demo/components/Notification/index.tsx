...
const NOTIFICATION_API: ApiRow[] = [
    ...
    { prop: 'variant', desc: '通知密度变体', type: "'default' | 'compact'", defaultVal: "'default'" },
        ...
        <div style={sectionStyle}>
            ...
            <div style={demoBodyStyle}>
                ...
                <div style={S.row}>
                    <Button
                        type="primary"
                        onClick={() => Notification.success({ message: '保存成功!', className: 'success-string-icon' })}
                    >
                        success 字符串
                    </Button>
                    <Button onClick={() => Notification.info('这是一条普通提示')}>info 字符串</Button>
                    <Button onClick={() => Notification.warning('XLM 可用余额偏低')}>warning 字符串</Button>
                    <Button type="primary" danger onClick={() => Notification.error('网络请求失败')}>
                        error 字符串
                    </Button>
                </div>

                <div style={labelStyle}>compact Toast</div>
                <div style={S.row}>
                    <Button
                        onClick={() =>
                ...
                <div style={S.row}>
                    <Button
                        ...
                        onClick={() =>
                            Notification.success({
                                message: '交易提交成功',
                                description: '交易已进入 Stellar 网络，正在等待账本确认。',
                            })
                        }
                    >
                        升级成功
                    ...
                    <Button
                        onClick={() =>
                            Notification.warning({
                                message: '可用余额偏低',
                                description: '当前 XLM 可用余额可能不足以支付后续交易费用。',
                            })
                        }
                    >
                        余额警告
                ...
                <div style={S.row}>
                    <Button
                        ...
                        onClick={() =>
                            Notification.open({
                                message: '收到签名请求',
                                description: '请核对交易详情后决定是否签名。',
                                btn: (
                                    <Button
                                        size="small"
                                        type="primary"
                                        onClick={() => {
                                            Notification.success('签名已确认');
                                        }}
                                    >
                                        确认签名
                                    </Button>
                    ...
                    <Button
                        onClick={() =>
                            Notification.info({
                                ...
                                description: '× 替换为文字',
                                closeIcon: (
                                    <span style={{ fontSize: 'var(--Fresnica-font-size-caption)', fontWeight: 700 }}>
                                        CLOSE
                                    </span>
                                ),
                            })
            ...
            <Button
                onClick={() =>
                    Notification.open({
                        message: '收到签名请求',
                        description: '请核对交易详情后决定是否签名。',
                        btn: <Button size="small" type="primary" onClick={() => Notification.success('签名已确认')}>确认签名</Button>,
                        duration: 0,
                    })
                }
            >
