 ...
 *        - skills/fresnica-ui-style/references/components/*.md (published skill)
 ...
 *   4. skills/fresnica-ui-style/SKILL.zh-CN.md exists (human-review translation).
 *
...
const SKILL_DIR = resolve(ROOT, 'skills/fresnica-ui-style');
...
const coverageGroups = {
    ...
    'skills/fresnica-ui-style/references/components/': listMarkdown(SKILL_COMPONENTS),
};
...
if (!existsSync(join(SKILL_DIR, 'SKILL.zh-CN.md'))) {
    problems.push('skills/fresnica-ui-style/SKILL.zh-CN.md is missing');
} else if (!statSync(join(SKILL_DIR, 'SKILL.zh-CN.md')).size) {
    problems.push('skills/fresnica-ui-style/SKILL.zh-CN.md is empty');
}
